...
JCN_Proj: BSlab.o JCN.o Main.o  
	$(CHARMC) -o $@ Main.o JCN.o BSlab.o RectGData.o CompJCN.o MrgJCN.o PtopeGeom.o PyramidTree.o -module CkMulticast -module CommonLBs -balance workstealing -tracemode projections $(OPTS)

$(BINARY): RectGData.o BSlab.o JCN.o Main.o 
	$(CHARMC) -o $@ Main.o JCN.o BSlab.o RectGData.o CompJCN.o MrgJCN.o PtopeGeom.o PyramidTree.o -module CkMulticast -module CommonLBs -balance workstealing $(OPTS)
